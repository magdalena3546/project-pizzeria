...
class Booking {
  constructor(element) {
    ...
    thisBooking.tableSelectedId = null;
          ...
          if (!clickedElm.classList.contains(classNames.booking.tableSelected)) {
            for (let table of thisBooking.dom.tables) {
              if (clickedElm != table) {
                ...
                thisBooking.tableSelectedId = clickedElm.getAttribute(settings.booking.tableIdAttribute);
              }
            }
          } else {
  ...
  render(element) {
    ...
    thisBooking.dom.wrapperTables = thisBooking.dom.wrapper.querySelector(select.containerOf.tables);
